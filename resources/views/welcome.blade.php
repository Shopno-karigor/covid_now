        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <table class="table">
                        <thead class="thead-dark">
                          <tr>
                            <th scope="col">Confirmed deaths (globally)</th>
                            <th scope="col">Recovered (globally)</th>
                            <th scope="col">Number of infected (globally)</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="{{route('other.feature')}}" class="underline text-gray-900 dark:text-white">Notifications</a>
                                </div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            Code from <a href="https://ratul.info/"> &nbsp;Ratul</a>
                        </div>
                    </div>
